...
BEGIN
  ...
  -- Clone watchlist from the curated watchlist_template table (which has target_prices),
  -- falling back to the template user's watchlist if the template table is empty.
  IF NOT EXISTS (
